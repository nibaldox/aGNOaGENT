...
agent_team = Team(
    ...
    2. Coordinate between the web researcher and financial analyst.
    ...
    16. Sign off with 'Market Watch Team' and the current date.
...
user_message = input("Por favor, introduce tu consulta para el equipo de agentes: ")
